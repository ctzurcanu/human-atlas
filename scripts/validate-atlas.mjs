...
const base=process.argv[3]?pathToFileURL(path.resolve(process.argv[3])+path.sep):new URL('../public/models/',import.meta.url),atlas=JSON.parse(fs.readFileSync(new URL(filename,base)));
