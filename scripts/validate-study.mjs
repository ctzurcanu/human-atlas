...
const s={...base,selected,contextOpacity:.17,region:'lower-left',peel:2,hidden:resolveSelection(atlas,['Patella.l']),skinOpacity:.2,section:{enabled:true,axis:'sagittal',position:.41,flip:true},labels:true};
