...
export interface Part {suppressed?:boolean;tissue?:string;regions?:string[];depth?:number;sourceId?:string;groups?:string[];provenance?:{label:string;url:string;detail:string};id:string;name:string;conceptId:string;system:SystemId;chunk:number;positions:number;normals:number;indices:number;vertexCount:number;indexCount:number;bounds:[number[],number[]]}
export interface Concept {id:string;name:string;elements:string[]}
export interface Atlas {quality?:'full'|'optimized';version:string;sex?:'male'|'female';source?:string;scope?:string;parts:Part[];concepts:Concept[];chunks:{url:string;bytes:number;gzip?:string;gzipBytes?:number}[];triangles:number}
